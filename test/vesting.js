...
contract('Vesting', function(accounts) {
  ...
  it("should assignSchedule correctly", function() {
     ...
     return Vesting.new(consensusXAddr).then(function(instance) {
       ...
       ("0xee370bbaf46ed8af654cd9987d64652dedf5f63e", "Wunmi", "10097400848139", "19097478848939", "19097438848939", "600", { from: consensusXAddr});
   ...
   it("should set consensusXAddr correctly", function() {
          ...
          vestingInstance.setConsensusXAddr(consensusXAddr, { from: consensusXAddr}).then(function() {

          assert.equal(consensusXAddr, consensusXAddr, "consensusXAddr not properly set!");
        });
    });
